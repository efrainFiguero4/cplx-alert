(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('rxjs/operators'), require('util'), require('rxjs'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('cplx-autocomplete', ['exports', '@angular/core', '@angular/forms', 'rxjs/operators', 'util', 'rxjs', '@angular/common'], factory) :
    (global = global || self, factory(global['cplx-autocomplete'] = {}, global.ng.core, global.ng.forms, global.rxjs.operators, global.util, global.rxjs, global.ng.common));
}(this, (function (exports, core, forms, operators, util, rxjs, common) { 'use strict';
    ...
    var CplxAutocompleteComponent = /** @class */ (function () {
        ...
        CplxAutocompleteComponent.prototype.ngOnInit = function () {
            ...
            }), operators.filter(function (res) { return !_this.filter ? res.length >= _this.minlength : true; }), operators.debounceTime(this.timeout), operators.distinctUntilChanged()).subscribe(function (text) {
                _this.value = text;
                _this.visible = true;
    ...
    exports.ReadOnlyDirective = ReadOnlyDirective;
